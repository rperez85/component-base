...
exports.default = function (literalSections) {
...
var Component = exports.Component = function () {
    ...
    _createClass(Component, [{
        ...
        value: function addData(data) {
            var doRender = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
...
exports.default = function (subject, events) {
    events = events || [];
    ...
    subject.off = function (eventName, callback, context) {
        if (this.observers) {
            //throw new Error('One false move, baby, suddenly everything's ruined');
            eventName = eventName.split(' ');
            for (var i = 0, l = eventName.length; i < l; i++) {
    ...
    var functionCall = function functionCall(observer, params) {
        return function () {
...
$(function () {
    //async function foo () {
    //    const result = await fetch("https://api/?results=10", { method: "GET" }); 
    //    return result;
    //}
    ...
    var menu = new _menu.Menu({
        ...
        updateData: function updateData(data) {
            ...
            console.log(data);
            //console.log(menu.componentState);          
        },
        updateState: function updateState(state) {
            console.log(state);
        },
        removeComponent: function removeComponent(data) {},
        methods: {
            'onClick': function onClick(e, data) {
                console.log(data);
                //console.log('click all component content');
            }
        }
    });

    menu.on('newButtonAdded', function (btn) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(93), __webpack_require__(334)(module)))
...
var _templateObject = _taggedTemplateLiteral(['\n            <h1>', '</h1>\n            <input type="text" id=', ' />\n            <input type="button" id=', ' value="a\xF1ade nuevo bot\xF3n" />\n            <div id="menu">\n                <ul>\n                    ', '                    \n                </ul>\n            </div>'], ['\n            <h1>', '</h1>\n            <input type="text" id=', ' />\n            <input type="button" id=', ' value="a\xF1ade nuevo bot\xF3n" />\n            <div id="menu">\n                <ul>\n                    ', '                    \n                </ul>\n            </div>']),
    _templateObject2 = _taggedTemplateLiteral(['\n                        <li>\n                            $', '\n                        </li>'], ['\n                        <li>\n                            $', '\n                        </li>']);

var _es6Template = __webpack_require__(90);

var _es6Template2 = _interopRequireDefault(_es6Template);

var _makeObservable = __webpack_require__(128);

var _makeObservable2 = _interopRequireDefault(_makeObservable);

var _array = __webpack_require__(339);

var array = _interopRequireWildcard(_array);

var _component_base = __webpack_require__(91);

var _buttonMenu = __webpack_require__(340);
...
var Menu = exports.Menu = function (_Component) {
    ...
    function Menu(props) {
        ...
        _this.componentState = {
            'estadoMenuButtonsInitial': _this.data.buttons
        };

        (0, _makeObservable2.default)(_this, ['newButtonAdded']);
        return _this;
    }
    ...
    _createClass(Menu, [{
        ...
        value: function events() {
            ...
            //native component method
            $(this.$el).find('#' + IDS.addButton).on('click', function () {
                var buttonText = $(_this2.$el).find('#' + IDS.buttonText).val();
                ...
                var arrButtons = [].concat(_toConsumableArray(_this2.data.buttons || {}), [newButton]);

                _this2.addData({
                    'buttons': arrButtons
                });

                _this2.trigger('newButtonAdded', newButton);
            });
        }
    }, {
        key: 'removeComponent',
        value: function removeComponent() {//native component method
            //notify in a general feedback for exmaple.
        ...
        value: function beforeRender() {
            //native component method
            //console.log('menu before rendered');
            this.addData({
                'completeName': this.data.name + ' ' + this.data.surname
            }, false);
        }
    }, {
        key: 'afterRender',
        value: function afterRender() {//native component method
        ...
        get: function get() {
            ...
            return (0, _es6Template2.default)(_templateObject, this.data.completeName, IDS.buttonText, IDS.addButton, this.data.buttons ? this.data.buttons.map(function (button) {
                return (0, _es6Template2.default)(_templateObject2, new _buttonMenu.ButtonMenu({
                    data: {
                        'text': button.text,
                        'href': button.href,
                    ...
                    removeComponent: function removeComponent(data) {
                        //cuando se borra el elemento hay que actualizar el data:                                    
                        _this3.addData({
                            'buttons': array.removeFromArray(_this3.data.buttons, data)
                        });
                    }
                }).on('updatedDataButton', function (buttonMenuData, text) {
                    if (text) {
                        _this3.addData({
                            'buttons': array.updateFromArray(_this3.data.buttons, buttonMenuData, {
                                'text': text,
                                'href': '#',
                                'subItems': []
                            })
...
var updateFromArray = function updateFromArray(array, element, elemenToUpdate) {
...
exports.updateFromArray = updateFromArray;
...
var _templateObject = _taggedTemplateLiteral(['            \n            <input type="button" class="removeButton" value="borrar" />\n            <input type="button" class="updateButton" value="modificar" />\n            <input type="text" class="updateText" />\n            <a class="btn" href="', '">', '</a>\n            $', '\n        '], ['            \n            <input type="button" class="removeButton" value="borrar" />\n            <input type="button" class="updateButton" value="modificar" />\n            <input type="text" class="updateText" />\n            <a class="btn" href="', '">', '</a>\n            $', '\n        ']);
...
var ButtonMenu = exports.ButtonMenu = function (_Component) {
    ...
    function ButtonMenu(props) {
        ...
        _this.componentState = {
            'estadoNewButtons': _this.data.text
        };

        (0, _makeObservable2.default)(_this, ['updatedDataButton']);
        return _this;
    }
    ...
    _createClass(ButtonMenu, [{
        ...
        value: function events() {
            ...
            if (this.data.subItems.length) {
                $(this.$el).find('.btn').on('click', function (e) {
                    if ($(_this2.$el).find('.subitems').is(':visible')) {
                        $(_this2.$el).find('.subitems').hide();
                    } else {
                        $(_this2.$el).find('.subitems').show();
                    }
            ...
            $(this.$el).find('.updateButton').on('click', function (e) {
                _this2.trigger('updatedDataButton', _this2.data, $(_this2.$el).find('.updateText').val());
            });
        }
    }, {
        key: 'removeComponent',
        ...
        key: 'beforeRender',
        value: function beforeRender() {//native component method
            //console.log('graph before rendered');
        }
    }, {
        key: 'afterRender',
        value: function afterRender() {//native component method
            //console.log('graph just rendered');
        }
    }, {
        key: 'updateData',
        value: function updateData() {//native component method
        ...
        get: function get() {
            ...
            var dropdownMenu = function dropdownMenu() {
                if (_this3.data.subItems.length) {
                    return new _dropdownMenu.DropdownMenu({
                        data: {
                            'subItems': _this3.data.subItems
                        },
                        methods: {
                            'onClick': function onClick() {
                                return console.log('dropdownMenu clicked');
                            }
                        }
                    }).render();
                } else {
            ...
            return (0, _es6Template2.default)(_templateObject, this.data.href, this.data.text, dropdownMenu());
        }
    }]);
...
var DropdownMenu = exports.DropdownMenu = function (_Component) {
    ...
    _createClass(DropdownMenu, [{
        key: 'events',
        value: function events() {//native component method
        ...
        get: function get() {
            ...
            return (0, _es6Template2.default)(_templateObject, this.data.subItems.map(function (subItem) {
                return (0, _es6Template2.default)(_templateObject2, subItem.href, subItem.text);
            }));
        }
    }]);
